...
import metalstack.api.v2.network_pb2 as _pb2
...
class NetworkService(Protocol):
    ...
    async def ListBaseNetworks(self, req: _pb2.NetworkServiceListBaseNetworksRequest, ctx: ServiceContext) -> _pb2.NetworkServiceListBaseNetworksResponse: ...
...
class NetworkServiceServer(ConnecpyServer):
    def __init__(self, *, service: NetworkService, server_path_prefix=""):
        ...
        self._endpoints = {
            ...
            "ListBaseNetworks": Endpoint[_pb2.NetworkServiceListBaseNetworksRequest, _pb2.NetworkServiceListBaseNetworksResponse](
                service_name="NetworkService",
                name="ListBaseNetworks",
                function=getattr(service, "ListBaseNetworks"),
                input=_pb2.NetworkServiceListBaseNetworksRequest,
                output=_pb2.NetworkServiceListBaseNetworksResponse,
                allowed_methods=("POST",),
            ),
...
class NetworkServiceSync(Protocol):
    ...
    def ListBaseNetworks(self, req: _pb2.NetworkServiceListBaseNetworksRequest, ctx: ServiceContext) -> _pb2.NetworkServiceListBaseNetworksResponse: ...
...
class NetworkServiceClient(ConnecpyClient):
    ...
    def ListBaseNetworks(
        self,
        *,
        request: _pb2.NetworkServiceListBaseNetworksRequest,
        ctx: Optional[ClientContext] = None,
        server_path_prefix: str = "",
        **kwargs,
    ) -> _pb2.NetworkServiceListBaseNetworksResponse:
        method = "POST"
        return self._make_request(
            url=f"{server_path_prefix}/metalstack.api.v2.NetworkService/ListBaseNetworks",
            ctx=ctx,
            request=request,
            response_class=_pb2.NetworkServiceListBaseNetworksResponse,
            method=method,
            **kwargs,
        )
