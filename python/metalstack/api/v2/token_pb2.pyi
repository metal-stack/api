...
class Token(_message.Message):
    __slots__ = ("uuid", "user", "description", "permissions", "expires", "issued_at", "token_type", "project_roles", "tenant_roles", "machine_roles", "infra_roles", "admin_role")
    ...
    class InfraRolesEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: str
        value: _common_pb2.InfraRole
        def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.InfraRole, str]] = ...) -> None: ...
    ...
    infra_roles: _containers.ScalarMap[str, _common_pb2.InfraRole]
...
class TokenServiceCreateRequest(_message.Message):
    __slots__ = ("description", "permissions", "expires", "project_roles", "tenant_roles", "machine_roles", "infra_roles", "admin_role")
    class ProjectRolesEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class TokenServiceUpdateRequest(_message.Message):
    __slots__ = ("uuid", "updated_at", "description", "permissions", "project_roles", "tenant_roles", "machine_roles", "infra_roles", "admin_role")
    class ProjectRolesEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    infra_roles: _containers.ScalarMap[str, _common_pb2.InfraRole]
    admin_role: _common_pb2.AdminRole
    def __init__(self, uuid: _Optional[str] = ..., updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., description: _Optional[str] = ..., permissions: _Optional[_Iterable[_Union[MethodPermission, _Mapping]]] = ..., project_roles: _Optional[_Mapping[str, _common_pb2.ProjectRole]] = ..., tenant_roles: _Optional[_Mapping[str, _common_pb2.TenantRole]] = ..., machine_roles: _Optional[_Mapping[str, _common_pb2.MachineRole]] = ..., infra_roles: _Optional[_Mapping[str, _common_pb2.InfraRole]] = ..., admin_role: _Optional[_Union[_common_pb2.AdminRole, str]] = ...) -> None: ...
