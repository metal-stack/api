...
class ComponentServicePingRequest(_message.Message):
    __slots__ = ("type", "identifier", "started_at", "version")
    ...
    def __init__(self, type: _Optional[_Union[ComponentType, str]] = ..., identifier: _Optional[str] = ..., started_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., version: _Optional[_Union[_version_pb2.Version, _Mapping]] = ...) -> None: ...
