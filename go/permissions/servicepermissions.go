...
func GetServices() []string {
	return []string{
		...
		"metalstack.api.v2.SwitchService",
...
func GetServicePermissions() *ServicePermissions {
	return &ServicePermissions{
		...
		Methods: map[string]bool{
			...
			"/metalstack.api.v2.SwitchService/Get":               true,
			"/metalstack.api.v2.SwitchService/List":              true,
		...
		Auditable: map[string]bool{
			...
			"/metalstack.api.v2.SwitchService/Get":               false,
			"/metalstack.api.v2.SwitchService/List":              false,
			"/metalstack.api.v2.TenantService/Create":            true,
			"/metalstack.api.v2.TenantService/Delete":            true,
