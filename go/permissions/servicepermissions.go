...
func GetServicePermissions() *ServicePermissions {
	return &ServicePermissions{
		...
		Auditable: map[string]bool{
			...
			"/metalstack.admin.v2.SizeImageConstraintService/Create": false,
			"/metalstack.admin.v2.SizeImageConstraintService/Delete": false,
			"/metalstack.admin.v2.SizeImageConstraintService/Get":    false,
			"/metalstack.admin.v2.SizeImageConstraintService/List":   false,
			"/metalstack.admin.v2.SizeImageConstraintService/Update": false,
			"/metalstack.admin.v2.SizeReservationService/Create":     true,
			"/metalstack.admin.v2.SizeReservationService/Delete":     true,
