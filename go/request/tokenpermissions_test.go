...
func Test_opa_getTokenPermissions(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			token: nil,
			want: tokenPermissions{
				"/grpc.reflection.v1.ServerReflection/ServerReflectionInfo":      map[string]bool{"*": true},
				"/grpc.reflection.v1alpha.ServerReflection/ServerReflectionInfo": map[string]bool{"*": true},
