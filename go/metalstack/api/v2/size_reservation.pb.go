...
const file_metalstack_api_v2_size_reservation_proto_rawDesc = "" +
	...
	"\x11size_reservations\x18\x01 \x03(\v2\".metalstack.api.v2.SizeReservationR\x10sizeReservations\"\xa5\x02\n" +
	...
	"\x04size\x18\x06 \x01(\tB\v\xbaH\br\x06\xc0\xb3\xae\xb1\x02\x01R\x04size\x12\x1e\n" +
	"\n" +
	"partitions\x18\a \x03(\tR\n" +
	"partitions\x12\x16\n" +
	"\x06amount\x18\b \x01(\x05R\x06amount\"\x91\x03\n" +
	...
	"\tpartition\x18\x06 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01H\x05R\tpartition\x88\x01\x01\x126\n" +
