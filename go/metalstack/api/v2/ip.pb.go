...
const file_metalstack_api_v2_ip_proto_rawDesc = "" +
	"\n" +
	"\x1ametalstack/api/v2/ip.proto\x12\x11metalstack.api.v2\x1a\x1bbuf/validate/validate.proto\x1a\x1emetalstack/api/v2/common.proto\x1a/metalstack/api/v2/predefined_string_rules.proto\"\xf3\x02\n" +
	"\x02IP\x12\x1c\n" +
	...
	"\x04name\x18\x04 \x01(\tB\v\xbaH\br\x06\xc0\xb3\xae\xb1\x02\x01H\x00R\x04name\x88\x01\x01\x12/\n" +
	"\vdescription\x18\x05 \x01(\tB\b\xbaH\x05r\x03\x18\x80\x01H\x01R\vdescription\x88\x01\x01\x12<\n" +
	...
	"\x05query\x18\x02 \x01(\v2\x1a.metalstack.api.v2.IPQueryR\x05query\"\xaf\x05\n" +
	"\aIPQuery\x12\x1c\n" +
