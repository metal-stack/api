...
const file_metalstack_api_v2_image_proto_rawDesc = "" +
	...
	"\x05image\x18\x01 \x01(\v2\x18.metalstack.api.v2.ImageR\x05image\"\xaa\x04\n" +
	"\x05Image\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\tB\n" +
	...
	"\vdescription\x18\x05 \x01(\tB\v\xbaH\br\x06ȳ\xae\xb1\x02\x01H\x01R\vdescription\x88\x01\x01\x12\x83\x01\n" +
	...
	"\aused_by\x18\x02 \x03(\tR\x06usedBy\"\xea\x04\n" +
	"\n" +
	"ImageQuery\x12\x1f\n" +
	"\x02id\x18\x01 \x01(\tB\n" +
	...
	"\x04name\x18\x04 \x01(\tB\v\xbaH\br\x06\xc0\xb3\xae\xb1\x02\x01H\x03R\x04name\x88\x01\x01\x122\n" +
	"\vdescription\x18\x05 \x01(\tB\v\xbaH\br\x06ȳ\xae\xb1\x02\x01H\x04R\vdescription\x88\x01\x01\x12O\n" +
