...
var file_metalstack_api_v2_machine_proto_goTypes = []any{
	...
	(*MachineIPMI)(nil),                     // 31: metalstack.api.v2.MachineIPMI
	(*MachineFRU)(nil),                      // 32: metalstack.api.v2.MachineFRU
...
var file_metalstack_api_v2_machine_proto_depIdxs = []int32{
	...
	47, // 8: metalstack.api.v2.MachineServiceUpdateRequest.labels:type_name -> metalstack.api.v2.UpdateLabels
	15, // 9: metalstack.api.v2.MachineServiceUpdateResponse.machine:type_name -> metalstack.api.v2.Machine
	36, // 10: metalstack.api.v2.MachineServiceListRequest.query:type_name -> metalstack.api.v2.MachineQuery
	15, // 11: metalstack.api.v2.MachineServiceListResponse.machines:type_name -> metalstack.api.v2.Machine
	15, // 12: metalstack.api.v2.MachineServiceDeleteResponse.machine:type_name -> metalstack.api.v2.Machine
	48, // 13: metalstack.api.v2.Machine.meta:type_name -> metalstack.api.v2.Meta
	49, // 14: metalstack.api.v2.Machine.partition:type_name -> metalstack.api.v2.Partition
	50, // 15: metalstack.api.v2.Machine.size:type_name -> metalstack.api.v2.Size
	24, // 16: metalstack.api.v2.Machine.hardware:type_name -> metalstack.api.v2.MachineHardware
	30, // 17: metalstack.api.v2.Machine.bios:type_name -> metalstack.api.v2.MachineBios
	18, // 18: metalstack.api.v2.Machine.allocation:type_name -> metalstack.api.v2.MachineAllocation
	16, // 19: metalstack.api.v2.Machine.status:type_name -> metalstack.api.v2.MachineStatus
	33, // 20: metalstack.api.v2.Machine.recent_provisioning_events:type_name -> metalstack.api.v2.MachineRecentProvisioningEvents
	17, // 21: metalstack.api.v2.MachineStatus.condition:type_name -> metalstack.api.v2.MachineCondition
	29, // 22: metalstack.api.v2.MachineStatus.led_state:type_name -> metalstack.api.v2.MachineChassisIdentifyLEDState
	3,  // 23: metalstack.api.v2.MachineStatus.liveliness:type_name -> metalstack.api.v2.MachineLiveliness
	1,  // 24: metalstack.api.v2.MachineCondition.state:type_name -> metalstack.api.v2.MachineState
	48, // 25: metalstack.api.v2.MachineAllocation.meta:type_name -> metalstack.api.v2.Meta
	51, // 26: metalstack.api.v2.MachineAllocation.image:type_name -> metalstack.api.v2.Image
	52, // 27: metalstack.api.v2.MachineAllocation.filesystem_layout:type_name -> metalstack.api.v2.FilesystemLayout
	...
	45, // 31: metalstack.api.v2.MachineAllocation.dns_server:type_name -> metalstack.api.v2.DNSServer
	46, // 32: metalstack.api.v2.MachineAllocation.ntp_server:type_name -> metalstack.api.v2.NTPServer
	35, // 33: metalstack.api.v2.MachineAllocation.vpn:type_name -> metalstack.api.v2.MachineVPN
	21, // 34: metalstack.api.v2.FirewallRules.egress:type_name -> metalstack.api.v2.FirewallEgressRule
	22, // 35: metalstack.api.v2.FirewallRules.ingress:type_name -> metalstack.api.v2.FirewallIngressRule
	...
	53, // 38: metalstack.api.v2.MachineNetwork.network_type:type_name -> metalstack.api.v2.NetworkType
	54, // 39: metalstack.api.v2.MachineNetwork.nat_type:type_name -> metalstack.api.v2.NATType
	28, // 40: metalstack.api.v2.MachineHardware.disks:type_name -> metalstack.api.v2.MachineBlockDevice
	25, // 41: metalstack.api.v2.MachineHardware.cpus:type_name -> metalstack.api.v2.MetalCPU
	26, // 42: metalstack.api.v2.MachineHardware.gpus:type_name -> metalstack.api.v2.MetalGPU
	27, // 43: metalstack.api.v2.MachineHardware.nics:type_name -> metalstack.api.v2.MachineNic
	27, // 44: metalstack.api.v2.MachineNic.neighbors:type_name -> metalstack.api.v2.MachineNic
	32, // 45: metalstack.api.v2.MachineIPMI.fru:type_name -> metalstack.api.v2.MachineFRU
	...
	44, // 51: metalstack.api.v2.MachineQuery.labels:type_name -> metalstack.api.v2.Labels
	37, // 52: metalstack.api.v2.MachineQuery.allocation:type_name -> metalstack.api.v2.MachineAllocationQuery
	38, // 53: metalstack.api.v2.MachineQuery.network:type_name -> metalstack.api.v2.MachineNetworkQuery
	39, // 54: metalstack.api.v2.MachineQuery.nic:type_name -> metalstack.api.v2.MachineNicQuery
	40, // 55: metalstack.api.v2.MachineQuery.disk:type_name -> metalstack.api.v2.MachineDiskQuery
	41, // 56: metalstack.api.v2.MachineQuery.ipmi:type_name -> metalstack.api.v2.MachineIPMIQuery
	42, // 57: metalstack.api.v2.MachineQuery.fru:type_name -> metalstack.api.v2.MachineFRUQuery
	43, // 58: metalstack.api.v2.MachineQuery.hardware:type_name -> metalstack.api.v2.MachineHardwareQuery
	1,  // 59: metalstack.api.v2.MachineQuery.state:type_name -> metalstack.api.v2.MachineState
	4,  // 60: metalstack.api.v2.MachineAllocationQuery.allocation_type:type_name -> metalstack.api.v2.MachineAllocationType
	5,  // 61: metalstack.api.v2.MachineService.Get:input_type -> metalstack.api.v2.MachineServiceGetRequest
	7,  // 62: metalstack.api.v2.MachineService.Create:input_type -> metalstack.api.v2.MachineServiceCreateRequest
	9,  // 63: metalstack.api.v2.MachineService.Update:input_type -> metalstack.api.v2.MachineServiceUpdateRequest
	11, // 64: metalstack.api.v2.MachineService.List:input_type -> metalstack.api.v2.MachineServiceListRequest
	13, // 65: metalstack.api.v2.MachineService.Delete:input_type -> metalstack.api.v2.MachineServiceDeleteRequest
	6,  // 66: metalstack.api.v2.MachineService.Get:output_type -> metalstack.api.v2.MachineServiceGetResponse
	8,  // 67: metalstack.api.v2.MachineService.Create:output_type -> metalstack.api.v2.MachineServiceCreateResponse
	10, // 68: metalstack.api.v2.MachineService.Update:output_type -> metalstack.api.v2.MachineServiceUpdateResponse
	12, // 69: metalstack.api.v2.MachineService.List:output_type -> metalstack.api.v2.MachineServiceListResponse
	14, // 70: metalstack.api.v2.MachineService.Delete:output_type -> metalstack.api.v2.MachineServiceDeleteResponse
