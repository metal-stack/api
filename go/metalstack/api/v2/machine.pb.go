...
type MachineVPN struct {
	...
	// Flavor of the vpn.
	Flavor        VPNFlavor `protobuf:"varint,6,opt,name=flavor,proto3,enum=metalstack.api.v2.VPNFlavor" json:"flavor,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_metalstack_api_v2_machine_proto_rawDesc = "" +
	...
	"\x03ips\x18\x05 \x03(\tB\f\xbaH\t\x92\x01\x06\xc0\xa4\xb3\xb1\x02\x01R\x03ips\x12>\n" +
	"\x06flavor\x18\x06 \x01(\x0e2\x1c.metalstack.api.v2.VPNFlavorB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06flavor\"\xc5\b\n" +
	"\fMachineQuery\x12!\n" +
