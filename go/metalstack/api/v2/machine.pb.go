...
type MachineVPN struct {
	...
	Ips []string `protobuf:"bytes,4,rep,name=ips,proto3" json:"ips,omitempty"`
	// Flavor of the vpn.
	Flavor        VPNFlavor `protobuf:"varint,5,opt,name=flavor,proto3,enum=metalstack.api.v2.VPNFlavor" json:"flavor,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MachineVPN) GetFlavor() VPNFlavor {
	if x != nil {
		return x.Flavor
	}
...
const file_metalstack_api_v2_machine_proto_rawDesc = "" +
	...
	"\x03ips\x18\x04 \x03(\tB\f\xbaH\t\x92\x01\x06\xc0\xa4\xb3\xb1\x02\x01R\x03ips\x12>\n" +
	"\x06flavor\x18\x05 \x01(\x0e2\x1c.metalstack.api.v2.VPNFlavorB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06flavor\"\xc5\b\n" +
	"\fMachineQuery\x12!\n" +
...
var file_metalstack_api_v2_machine_proto_goTypes = []any{
	...
	(VPNFlavor)(0),                           // 68: metalstack.api.v2.VPNFlavor
}
var file_metalstack_api_v2_machine_proto_depIdxs = []int32{
	...
	68, // 62: metalstack.api.v2.MachineVPN.flavor:type_name -> metalstack.api.v2.VPNFlavor
	55, // 63: metalstack.api.v2.MachineQuery.labels:type_name -> metalstack.api.v2.Labels
	48, // 64: metalstack.api.v2.MachineQuery.allocation:type_name -> metalstack.api.v2.MachineAllocationQuery
	49, // 65: metalstack.api.v2.MachineQuery.network:type_name -> metalstack.api.v2.MachineNetworkQuery
	50, // 66: metalstack.api.v2.MachineQuery.nic:type_name -> metalstack.api.v2.MachineNicQuery
	51, // 67: metalstack.api.v2.MachineQuery.disk:type_name -> metalstack.api.v2.MachineDiskQuery
	52, // 68: metalstack.api.v2.MachineQuery.bmc:type_name -> metalstack.api.v2.MachineBMCQuery
	53, // 69: metalstack.api.v2.MachineQuery.fru:type_name -> metalstack.api.v2.MachineFRUQuery
	54, // 70: metalstack.api.v2.MachineQuery.hardware:type_name -> metalstack.api.v2.MachineHardwareQuery
	...
	55, // 73: metalstack.api.v2.MachineAllocationQuery.labels:type_name -> metalstack.api.v2.Labels
	46, // 74: metalstack.api.v2.MachineAllocationQuery.vpn:type_name -> metalstack.api.v2.MachineVPN
	7,  // 75: metalstack.api.v2.MachineService.Get:input_type -> metalstack.api.v2.MachineServiceGetRequest
	9,  // 76: metalstack.api.v2.MachineService.Create:input_type -> metalstack.api.v2.MachineServiceCreateRequest
	12, // 77: metalstack.api.v2.MachineService.Update:input_type -> metalstack.api.v2.MachineServiceUpdateRequest
	14, // 78: metalstack.api.v2.MachineService.List:input_type -> metalstack.api.v2.MachineServiceListRequest
	16, // 79: metalstack.api.v2.MachineService.Delete:input_type -> metalstack.api.v2.MachineServiceDeleteRequest
	18, // 80: metalstack.api.v2.MachineService.BMCCommand:input_type -> metalstack.api.v2.MachineServiceBMCCommandRequest
	20, // 81: metalstack.api.v2.MachineService.GetBMC:input_type -> metalstack.api.v2.MachineServiceGetBMCRequest
	8,  // 82: metalstack.api.v2.MachineService.Get:output_type -> metalstack.api.v2.MachineServiceGetResponse
	11, // 83: metalstack.api.v2.MachineService.Create:output_type -> metalstack.api.v2.MachineServiceCreateResponse
	13, // 84: metalstack.api.v2.MachineService.Update:output_type -> metalstack.api.v2.MachineServiceUpdateResponse
	15, // 85: metalstack.api.v2.MachineService.List:output_type -> metalstack.api.v2.MachineServiceListResponse
	17, // 86: metalstack.api.v2.MachineService.Delete:output_type -> metalstack.api.v2.MachineServiceDeleteResponse
	19, // 87: metalstack.api.v2.MachineService.BMCCommand:output_type -> metalstack.api.v2.MachineServiceBMCCommandResponse
	21, // 88: metalstack.api.v2.MachineService.GetBMC:output_type -> metalstack.api.v2.MachineServiceGetBMCResponse
...
func file_metalstack_api_v2_machine_proto_init() {
	...
	file_metalstack_api_v2_vpn_proto_init()
