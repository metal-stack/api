...
type BMCServiceClient interface {
	...
	WaitForMachineEvent(context.Context) (*connect.BidiStreamForClientSimple[v2.WaitForMachineEventRequest, v2.WaitForMachineEventResponse], error)
}
...
func (c *bMCServiceClient) WaitForMachineEvent(ctx context.Context) (*connect.BidiStreamForClientSimple[v2.WaitForMachineEventRequest, v2.WaitForMachineEventResponse], error) {
	return c.waitForMachineEvent.CallBidiStreamSimple(ctx)
}
...
type BMCServiceHandler interface {
	...
	UpdateBMCInfo(context.Context, *v2.UpdateBMCInfoRequest) (*v2.UpdateBMCInfoResponse, error)
	// WaitForMachineEvent is called by the metal-bmc and is returned with a bmc command to execute.
	WaitForMachineEvent(context.Context, *connect.BidiStream[v2.WaitForMachineEventRequest, v2.WaitForMachineEventResponse]) error
}
...
func NewBMCServiceHandler(svc BMCServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	bMCServiceWaitForMachineEventHandler := connect.NewBidiStreamHandler(
...
func (UnimplementedBMCServiceHandler) WaitForMachineEvent(context.Context, *connect.BidiStream[v2.WaitForMachineEventRequest, v2.WaitForMachineEventResponse]) error {
