...
const file_metalstack_infra_v2_event_proto_rawDesc = "" +
	...
	"\x18EventServiceSendResponse\"\xdf\x01\n" +
	"\x1cEventServiceSendMultiRequest\x12U\n" +
	"\x06events\x18\x01 \x03(\v2=.metalstack.infra.v2.EventServiceSendMultiRequest.EventsEntryR\x06events\x1ah\n" +
