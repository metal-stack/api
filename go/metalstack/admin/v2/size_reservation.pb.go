...
const file_metalstack_admin_v2_size_reservation_proto_rawDesc = "" +
	...
	"\x10size_reservation\x18\x01 \x01(\v2\".metalstack.api.v2.SizeReservationR\x0fsizeReservation\"\x8b\x03\n" +
	...
	"partitions\x12\x1b\n" +
	"\x06amount\x18\x06 \x01(\x05H\x02R\x06amount\x88\x01\x01\x12<\n" +
	...
	"\x11size_reservations\x18\x01 \x03(\v2\".metalstack.api.v2.SizeReservationR\x10sizeReservations2\xbe\x04\n" +
	...
	"\x06Delete\x128.metalstack.admin.v2.SizeReservationServiceDeleteRequest\x1a9.metalstack.admin.v2.SizeReservationServiceDeleteResponse\"\t\xd2\xf3\x18\x01\x01\xe0\xf3\x18\x01\x12\x82\x01\n" +
	"\x04List\x126.metalstack.admin.v2.SizeReservationServiceListRequest\x1a7.metalstack.admin.v2.SizeReservationServiceListResponse\"\t\xd2\xf3\x18\x01\x01\xe0\xf3\x18\x02B\xd8\x01\n" +
