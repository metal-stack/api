...
const file_metalstack_admin_v2_ip_proto_rawDesc = "" +
	...
	"\x03ips\x18\x01 \x03(\v2\x15.metalstack.api.v2.IPR\x03ips2v\n" +
	"\tIPService\x12i\n" +
...
var file_metalstack_admin_v2_ip_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_metalstack_admin_v2_ip_proto_goTypes = []any{
	...
	(*v2.IPQuery)(nil),            // 2: metalstack.api.v2.IPQuery
	(*v2.IP)(nil),                 // 3: metalstack.api.v2.IP
}
var file_metalstack_admin_v2_ip_proto_depIdxs = []int32{
	2, // 0: metalstack.admin.v2.IPServiceListRequest.query:type_name -> metalstack.api.v2.IPQuery
	3, // 1: metalstack.admin.v2.IPServiceListResponse.ips:type_name -> metalstack.api.v2.IP
	0, // 2: metalstack.admin.v2.IPService.List:input_type -> metalstack.admin.v2.IPServiceListRequest
	1, // 3: metalstack.admin.v2.IPService.List:output_type -> metalstack.admin.v2.IPServiceListResponse
