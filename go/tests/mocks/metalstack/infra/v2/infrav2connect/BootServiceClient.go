...
func (_m *BootServiceClient) AbortReinstall(_a0 context.Context, _a1 *connect.Request[infrav2.BootServiceAbortReinstallRequest]) (*connect.Response[infrav2.BootServiceAbortReinstallResponse], error) {
