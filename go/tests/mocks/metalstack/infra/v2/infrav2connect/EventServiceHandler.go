...
func (_m *EventServiceHandler) Send(_a0 context.Context, _a1 *connect.Request[infrav2.EventServiceSendRequest]) (*connect.Response[infrav2.EventServiceSendResponse], error) {
...
func (_m *EventServiceHandler) SendMulti(_a0 context.Context, _a1 *connect.Request[infrav2.EventServiceSendMultiRequest]) (*connect.Response[infrav2.EventServiceSendMultiResponse], error) {
	ret := _m.Called(_a0, _a1)
