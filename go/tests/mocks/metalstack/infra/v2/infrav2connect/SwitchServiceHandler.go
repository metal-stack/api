...
func (_m *SwitchServiceHandler) Notify(_a0 context.Context, _a1 *connect.Request[infrav2.SwitchServiceNotifyRequest]) (*connect.Response[infrav2.SwitchServiceNotifyResponse], error) {
