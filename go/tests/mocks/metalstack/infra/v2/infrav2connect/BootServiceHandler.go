...
// AbortReinstall provides a mock function with given fields: _a0, _a1
func (_m *BootServiceHandler) AbortReinstall(_a0 context.Context, _a1 *connect.Request[infrav2.BootServiceAbortReinstallRequest]) (*connect.Response[infrav2.BootServiceAbortReinstallResponse], error) {
	ret := _m.Called(_a0, _a1)

	if len(ret) == 0 {
		panic("no return value specified for AbortReinstall")
	}

	var r0 *connect.Response[infrav2.BootServiceAbortReinstallResponse]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *connect.Request[infrav2.BootServiceAbortReinstallRequest]) (*connect.Response[infrav2.BootServiceAbortReinstallResponse], error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *connect.Request[infrav2.BootServiceAbortReinstallRequest]) *connect.Response[infrav2.BootServiceAbortReinstallResponse]); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*connect.Response[infrav2.BootServiceAbortReinstallResponse])
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *connect.Request[infrav2.BootServiceAbortReinstallRequest]) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
