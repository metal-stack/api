...
// ConsolePassword provides a mock function for the type MachineServiceHandler
func (_mock *MachineServiceHandler) ConsolePassword(context1 context.Context, machineServiceConsolePasswordRequest *adminv2.MachineServiceConsolePasswordRequest) (*adminv2.MachineServiceConsolePasswordResponse, error) {
...
// MachineServiceHandler_ConsolePassword_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ConsolePassword'
type MachineServiceHandler_ConsolePassword_Call struct {
	*mock.Call
}
...
func (_c *MachineServiceHandler_ConsolePassword_Call) Run(run func(context1 context.Context, machineServiceConsolePasswordRequest *adminv2.MachineServiceConsolePasswordRequest)) *MachineServiceHandler_ConsolePassword_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MachineServiceHandler_ConsolePassword_Call) Return(machineServiceConsolePasswordResponse *adminv2.MachineServiceConsolePasswordResponse, err error) *MachineServiceHandler_ConsolePassword_Call {
