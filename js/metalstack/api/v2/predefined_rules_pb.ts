 ...
 */
export const is_base64: GenExtension<StringRules, boolean> = /*@__PURE__*/
...
export const machine_roles_keys_valid: GenExtension<MapRules, boolean> = /*@__PURE__*/
  extDesc(file_metalstack_api_v2_predefined_rules, 24);
